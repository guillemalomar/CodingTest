...
class MerchantToolTests(unittest.TestCase):
    def test_calculate_assigns(self):
        input_data = process_input('MerchantsguidetothegalaxyPythonGA/tests/test_input.txt')
    ...
    def test_calculate_assigns_exc(self):
        input_data = process_input('MerchantsguidetothegalaxyPythonGA/tests/test_input_2.txt')
        my_merchant = MerchantTool()
        raisenError = False
        try:
            my_merchant.calculate_assigns(input_data)
